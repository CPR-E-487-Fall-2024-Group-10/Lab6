...
class Model {
   public:
    ...
    // Functions
    const LayerData& inference(const LayerData& inData, const Layer::InfType infType = Layer::InfType::NAIVE, const Layer::QuantType quantType = Layer::QuantType::INT8) const;
    const LayerData& inferenceLayer(const LayerData& inData, const int layerNum, const Layer::InfType infType = Layer::InfType::NAIVE, const Layer::QuantType quantType = Layer::QuantType::INT8) const;
